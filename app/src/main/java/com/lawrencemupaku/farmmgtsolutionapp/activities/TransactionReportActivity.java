...
public class TransactionReportActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TransactionReportActivity.this,ReportActivity.class);
    ...
    private void requestPermission(){
        ActivityCompat.requestPermissions(TransactionReportActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, 1);
    }

    private void convertToPdf() {
        PdfGenerator pdfGenerator = new PdfGenerator(TransactionReportActivity.this);
